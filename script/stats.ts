...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/groeimetai/snow-flow/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for groeimetai/snow-flow...\n")
...
console.log("Fetching npm all-time downloads for snow-flow...\n")
const npmDownloads = await fetchNpmDownloads("snow-flow")
