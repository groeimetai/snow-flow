...
function getSupportedArtifacts(category) {
    const allArtifacts = [
        // UI Artifacts
...
function getArtifactFields(table) {
    const fieldMappings = {
        sp_widget: {
...
function getArtifactCapabilities(table) {
    return {
        supports_pull: true,
        supports_push: true,
...
//# sourceMappingURL=snow_list_supported_artifacts.js.map