...
async function execute(args, context) {
    const { short_description, description = '', caller_id, urgency = 3, impact = 3, category, subcategory, assignment_group, assigned_to, configuration_item, auto_assign = false } = args;
    try {
...
//# sourceMappingURL=snow_create_incident.js.map