...
async function execute(args, context) {
    ...
    try {
        ...
        if (licenseData.length === 0) {
            return (0, error_handler_js_1.createErrorResult)('No licenses found for analysis');
        }
        // Analyze each license
        const optimizations = await Promise.all(licenseData.map(async (license) => {
...
function generateRecommendations(optimizationType, optimizations) {
...
//# sourceMappingURL=snow_optimize_licenses.js.map