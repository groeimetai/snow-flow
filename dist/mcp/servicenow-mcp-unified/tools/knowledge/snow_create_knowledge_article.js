...
async function execute(args, context) {
    const { short_description, text, kb_knowledge_base, kb_category, article_type = 'text', workflow_state = 'draft', valid_to, meta_description, keywords, author } = args;
    try {
        ...
        if (valid_to)
            articleData.valid_to = valid_to;
        if (meta_description)
            articleData.meta_description = meta_description;
        if (keywords)
...
//# sourceMappingURL=snow_create_knowledge_article.js.map