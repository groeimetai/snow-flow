...
async function execute(args, context) {
    const { broadcast_type, target_audience, group_id, message, channels = ['email', 'push'], override_preferences = true, require_acknowledgment = false } = args;
    try {
...
//# sourceMappingURL=snow_emergency_broadcast.js.map