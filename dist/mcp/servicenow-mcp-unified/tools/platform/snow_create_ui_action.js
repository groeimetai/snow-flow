...
async function execute(args, context) {
    const { name, table, action_name, script, description = '', action_type = 'form_button', client = true, onclick, condition = '', order = 100, active = true, show_insert = true, show_update = true } = args;
    try {
        const client_instance = await (0, auth_js_1.getAuthenticatedClient)(context);
        // Create UI Action
        const uiActionData = {
            name,
            table,
...
//# sourceMappingURL=snow_create_ui_action.js.map