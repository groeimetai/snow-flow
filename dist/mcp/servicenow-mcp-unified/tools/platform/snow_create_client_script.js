...
async function execute(args, context) {
    const { name, table, type = 'onLoad', script, field_name, ui_type = 'both', description = '', condition = '', active = true, global: isGlobal = false } = args;
    try {
...
//# sourceMappingURL=snow_create_client_script.js.map