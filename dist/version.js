...
exports.VERSION_INFO = {
    ...
    features: {
        ...
        '1.4.39': [
            ...
            '🗑️ DEPRECATED REMOVAL: Removed bottleneck_analyze, github tools, daa tools, workflow_create, sparc_mode',
            '❌ FLOW TOOLS: Removed flow_wizard and validate_flow_definition from deployment MCP',
            '📊 TOOL OPTIMIZATION: Focused on 100% working tools based on comprehensive test results',
            '🔧 FIXES: Resolved all TypeScript compilation errors and tool registry issues',
        ],
        '1.4.38': [
            '🗑️ FLOW TOOL REMOVAL: Removed ALL flow-related MCP tools from codebase',
            '✅ REMOVED TOOLS: snow_test_flow_with_mock, snow_link_catalog_to_flow, snow_deploy_flow',
            '🧹 CLEANUP COMPLETE: Removed flow discovery, testing, and XML flow MCP servers',
            '📚 DOCUMENTATION: Updated all docs to remove flow creation references',
            '🚀 WIDGET FOCUS: Snow-Flow now focuses exclusively on widgets, scripts, and automation',
            '🎯 CLEANER CODEBASE: Removed 1000+ lines of deprecated flow code',
        ],
        '1.4.37': [
            '🔧 AUTH DIAGNOSTICS FIX: Fixed misleading "No credentials available" error',
            '✅ PROPER ERROR: validateDeploymentPermissions now calls ensureAuthenticated first',
            '📊 BETTER DIAGNOSTICS: More accurate authentication status reporting',
            '🚀 NO MORE CONFUSION: OAuth status and API call errors now properly separated',
        ],
        '1.4.36': [
            '🗑️ REMOVED FLOW-COMPOSER: Completely removed flow-composer from all configurations',
            '📝 TEMPLATE-BASED INIT: Init command now uses .mcp.json.template for consistency',
            '✅ CLEANER CODEBASE: Template-based MCP configuration for better maintainability',
            '🧹 NO MORE FLOWS: Final cleanup of flow creation features (use ServiceNow Flow Designer)',
            '🚀 11 MCP SERVERS: All ServiceNow operations without flow-composer complexity',
        ],
        '1.4.35': [
            '🎉 ALL MCP SERVERS: Fixed init command to include ALL snow-flow MCP servers automatically',
            '🤖 MEMORY_USAGE FIXED: Added snow-flow server (contains memory_usage and orchestration tools)',
            '✅ AUTO-CONFIG: No more manual MCP server configuration needed for new projects',
            '📝 COMPLETE SETUP: Complete .mcp.json created with all servers on init --sparc',
            '🚀 ONE COMMAND: snow-flow init --sparc creates everything you need',
        ],
        '1.4.34': [
            '🧹 FINAL CLEANUP: Removed ALL remaining external tool references from changelog and docs',
            '📝 VERSION CHANGELOG: Cleaned version.ts changelog of all external tool references',
            '📚 DOCUMENTATION: Updated CHANGELOG.md and ARCHITECTURE.md to remove external tool references',
            '🗃️ CONFIG FILES: Cleaned .gitignore and .npmignore of external tool patterns',
            '✅ ZERO REFERENCES: Verified 0% external tool references in entire codebase',
            '🚀 PURE SNOW-FLOW: Now completely independent native Snow-Flow implementation',
        ],
        '1.4.33': [
            '🔍 ROOT CAUSE FOUND: Fixed .claude/settings.json still containing CLAUDE_FLOW_* environment variables',
            '🔧 ENV VARIABLES FIX: Changed all CLAUDE_FLOW_* to SNOW_FLOW_* in settings',
            '🎯 FINAL SOLUTION: This was causing snow-flow to still show snow-flow/snow-flow-native servers',
            '✅ COMPLETE CLEANUP: Now truly 0% snow-flow references in entire system',
            '🚀 READY FOR USE: Snow-flow now shows only snow-flow-* MCP servers',
        ],
        '1.4.32': [
            '🚨 MCP CLEANUP SCRIPT: Created automated script to remove snow-flow/snow-flow-native from Claude Desktop',
            '🔧 FIX-MCP-REFERENCES: Script automatically cleans Claude config and reinstalls Snow-Flow MCP servers',
            '📋 USER INSTRUCTIONS: Clear steps to completely remove snow-flow/snow-flow-native from MCP list',
            '🎯 CLAUDE DESKTOP FIX: Solves issue where users still see snow-flow in MCP output',
            '✨ CLEAN INSTALL: Ensures only snow-flow-* servers appear in Claude Desktop MCP list',
        ],
        '1.4.31': [
            '🔍 COMPREHENSIVE AUDIT: Deep verification of ALL snow-flow to snow-flow command mapping',
            '📂 COMMAND DIRECTORY CLEANUP: Updated ALL 100+ .claude/commands/*.md files',
            '🗂️ FILE RENAME: snow-flow-swarm.md → snow-flow-swarm.md with complete content update',
            '💾 SOURCE CODE SWEEP: Updated ALL src/*.ts files to use snow-flow exclusively',
            '📚 DOCUMENTATION SYNC: README.md, CLAUDE.md, and all docs now 100% snow-flow',
            '✅ VERIFIED COMPLETE: Every snow-flow command has functional snow-flow counterpart',
            '🎯 ZERO REFERENCES: 0 snow-flow references remaining in codebase',
        ],
        '1.4.30': [
            '🧹 FINAL CLAUDE-FLOW CLEANUP: Removed ALL remaining snow-flow references from .claude directory',
            '📜 SCRIPT UPDATES: Fixed setup-mcp.sh, github-setup.sh, quick-start.sh to use snow-flow',
            '📚 COMMAND DOCS: Renamed and updated snow-flow-memory.md and snow-flow-help.md files',
            '🔧 MCP SETUP: Fixed MCP server registration to use snow-flow instead of snow-flow',
        ...
        '1.4.27': [
            ...
            '🎯 REPLACES EXTERNAL TOOLS: Snow-Flow now replaces snow-flow/snow-flow-native completely',
            '🧹 REMOVED DEPENDENCIES: Cleaned all snow-flow/snow-flow-native references from settings',
        ...
        '1.4.14': [
            '🚀 SNOW-FLOW MCP SERVER: Created complete coordination server replacing snow-flow MCP',
        ...
        '1.4.9': [
            '🔄 DIRECTORY MIGRATION: Migrated all .snow-flow directories to .snow-flow for brand consistency',
            '📁 PROJECT STRUCTURE: Updated Queen memory, MCP memory, and test paths to use .snow-flow',
            '🚀 AUTOMATIC MIGRATION: Init command now auto-migrates existing .snow-flow data to .snow-flow',
            '✨ ENHANCED INIT: Creates .snow-flow/queen, .snow-flow/memory directories during initialization',
            '🛡️ SAFE MIGRATION: Original .snow-flow data preserved during migration for safety',
            '🧹 CODE CLEANUP: Replaced all snow-flow references with snow-flow in project paths',
            '📝 MIGRATION UTILITY: New migrate-snow-flow.ts handles automatic data migration',
        ],
        '1.4.13': [
        ...
        '1.4.12': [
            '🏷️ COMPLETE BRAND CONSISTENCY: Replaced ALL snow-flow references with snow-flow in CLAUDE.md',
            ...
            '🔧 CLI COMMANDS: Fixed all npx snow-flow to npx snow-flow',
        ...
        '1.4.11': [
            '🔧 TEMPLATE FIX: Fixed .claude.settings.template to use snow-flow instead of snow-flow',
        ...
        '1.4.10': [
            '🏷️ BRAND UPDATE: Fixed remaining snow-flow references in CLAUDE.md',
        ...
        '1.1.77': [
            '🧠 COMPLETE HIVE-MIND: Full snow-flow architecture implementation',
        ...
        '1.1.76': [
            '👑 REVOLUTIONARY: ServiceNow Queen Agent - Hive-Mind Intelligence inspired by snow-flow!',
            ...
            '🎉 TRANSFORMATION: From enterprise complexity to snow-flow elegance - COMPLETE!',
        ],
        '1.1.75': [
        ...
        '1.1.68': [
            ...
            '🏷️ BRAND UPDATE: Replaced all snow-flow references with snow-flow in CLAUDE.md files',
        ...
        '1.1.63': [
            ...
            '🏷️ BRAND CONSISTENCY: Replaced all snow-flow references with snow-flow throughout codebase',
