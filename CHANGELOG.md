...
### Fixed
- **🐛 Critical Build Fix**: Added `src/memory/session-memory.ts` to git (was incorrectly gitignored)
...
### Added
- **📚 Documentation**: Added RESTART-INSTRUCTIONS.md with step-by-step guide for restarting SnowCode/Claude Code to load new MCP servers
