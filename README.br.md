<p align="center">
  <a href="https://snow-flow.dev">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo do Snow-Flow">
    </picture>
  </a>
</p>
...
O Snow-Flow também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/groeimetai/snow-flow/releases) ou em [snow-flow.dev/download](https://snow-flow.dev/download).
...
**Junte-se à nossa comunidade** [Discord](https://discord.gg/snow-flow) | [X.com](https://x.com/snow-flow)
