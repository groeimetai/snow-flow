...
Snow-Flow comes with one built-in subagent, **General**. We'll look at this below.

---

## Built-in

Snow-Flow comes with two built-in primary agents and one built-in subagent.
...
Configure agents in your `.mcp.json` config file:
...
- Global: `~/.config/snow-flow/agent/`
- Per-project: `.snow-flow/agent/`

```markdown title="~/.config/snow-flow/agent/review.md"
---
...
:::tip
Run `snow-flow models` to see a list of the available models.
:::
...
```markdown title="~/.config/snow-flow/agent/docs-writer.md"
---
...
```markdown title="~/.config/snow-flow/agent/security-auditor.md"
---
