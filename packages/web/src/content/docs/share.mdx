...
To enforce this across your team for a given project, add it to the `snowcode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using snow-code in your organization.
