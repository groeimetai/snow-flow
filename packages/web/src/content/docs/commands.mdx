...
Create `.snow-code/commands/test.md`:

```md title=".snow-code/commands/test.md"
---
...
You can add custom commands through the Snow-Flow config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Snow-Flow [config](/docs/config):

```json title="snowcode.jsonc" {4-12}
{
...
- Global: `~/.config/snow-code/commands/`
- Per-project: `.snow-code/commands/`

```markdown title="~/.config/snow-code/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".snow-code/commands/component.md"
---
...
```md title=".snow-code/commands/create-file.md"
---
...
```md title=".snow-code/commands/analyze-coverage.md"
---
...
```md title=".snow-code/commands/review-changes.md"
---
...
```md title=".snow-code/commands/review-component.md"
---
...
snow-code includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
