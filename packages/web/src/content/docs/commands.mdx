...
Create `.snow-flow/command/test.md`:

```md title=".snow-flow/command/test.md"
---
...
You can add custom commands through the Snow-Flow config or by creating markdown files in the `command/` directory.
...
- Global: `~/.config/snow-flow/command/`
- Per-project: `.snow-flow/command/`

```markdown title="~/.config/snow-flow/command/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".snow-flow/command/component.md"
---
...
```md title=".snow-flow/command/create-file.md"
---
...
```md title=".snow-flow/command/analyze-coverage.md"
---
...
```md title=".snow-flow/command/review-changes.md"
---
...
```md title=".snow-flow/command/review-component.md"
---
...
snow-flow includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
