...
description: What's new in Snow-Flow 1.0.
---

Snow-Flow 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same snow-code server.
...
version. However some older versions of Snow-Flow always grab latest.

To upgrade manually, run

```bash
$ snow-code upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ snow-code upgrade 0.15.31
```
