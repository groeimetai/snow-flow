...
export const toolDefinition: MCPToolDefinition = {
  ...
  inputSchema: {
    ...
    properties: {
      action: {
        type: 'string',
        enum: ['list', 'get', 'create', 'update', 'delete', 'enable', 'disable', 'run_now', 'get_history', 'get_next_run'],
      ...
      case 'list': {
        ...
        const response = await client.get('/api/now/table/sysauto_script', {
          params: {
            ...
            sysparm_fields: 'sys_id,name,active,run_type,run_time,run_start,run_dayofweek,run_dayofmonth,sys_created_on,sys_updated_on',
            sysparm_limit: limit
          }
        });
