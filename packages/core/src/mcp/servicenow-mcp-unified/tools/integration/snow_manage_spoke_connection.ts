  ...
  try {
    ...
    if (action === 'list') {
      ...
      return createSuccessResult({
        ...
        summary: {
          active: enrichedConnections.filter(function(c: any) { return c.active; }).length,
          inactive: enrichedConnections.filter(function(c: any) { return !c.active; }).length,
          with_credentials: enrichedConnections.filter(function(c: any) { return c.credential; }).length
        }
      });
