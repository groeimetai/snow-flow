...
async function listMethods(client: any, args: any): Promise<ToolResult> {
  ...
  if (!messageSysId) {
    throw new SnowFlowError(ErrorType.VALIDATION_ERROR, 'rest_message_sys_id or name is required for list_methods action');
  }
...
async function listMessageHeaders(client: any, args: any): Promise<ToolResult> {
  ...
  if (!messageSysId) {
    throw new SnowFlowError(ErrorType.VALIDATION_ERROR, 'rest_message_sys_id, sys_id, or name is required for list_message_headers action');
  }
...
async function createMessageHeader(client: any, args: any): Promise<ToolResult> {
  ...
  if (!messageSysId) {
    throw new SnowFlowError(ErrorType.VALIDATION_ERROR, 'rest_message_sys_id, sys_id, or name is required for create_message_header action');
  }
...
async function deleteMessageHeader(client: any, args: any): Promise<ToolResult> {
  ...
  if (headerSysIdToDelete) {
    ...
    throw new SnowFlowError(ErrorType.VALIDATION_ERROR, 'Either header_sys_id/sys_id OR (header_name + rest_message_sys_id/name) is required');
  }
}
...
async function deleteMethodHeader(client: any, args: any): Promise<ToolResult> {
  ...
  if (headerSysIdToDelete) {
    ...
    throw new SnowFlowError(ErrorType.VALIDATION_ERROR, 'Either header_sys_id/sys_id OR (header_name + method_sys_id) is required');
  }
}
...
async function createParameter(client: any, args: any): Promise<ToolResult> {
  ...
  if (parameters && typeof parameters === 'object') {
    ...
    throw new SnowFlowError(ErrorType.VALIDATION_ERROR, 'Either parameters object or parameter_name+parameter_value is required');
  }
...
async function deleteParameter(client: any, args: any): Promise<ToolResult> {
  ...
  if (paramSysIdToDelete) {
    ...
    throw new SnowFlowError(ErrorType.VALIDATION_ERROR, 'Either parameter_sys_id/sys_id OR (parameter_name + method_sys_id) is required');
  }
}
