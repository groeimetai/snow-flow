...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Snow-Flow 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Snow-Flow 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Snow-Flow Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Snow-Flow 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Snow-Flow 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 snow-code.jsonc 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Snow-Flow 服务器。",
  ...
  "toast.update.description": "Snow-Flow 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Snow-Flow 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (snow-code.jsonc) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Snow-Flow 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Snow-Flow 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Snow-Flow 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Snow-Flow 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Snow-Flow 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Snow-Flow 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Snow-Flow。",
