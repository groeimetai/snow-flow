export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Snow-Flow",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Snow-Flow.",
  ...
  "provider.connect.opencodeZen.line1":
    "Snow-Flow Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Snow-Flow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Snow-Flow.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i snow-code.jsonc",
  ...
  "dialog.server.description": "Skift hvilken Snow-Flow-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Snow-Flow ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Snow-Flow-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (snow-code.jsonc) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Snow-Flow understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Snow-Flow inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Snow-Flow",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Snow-Flow ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Snow-Flow er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Snow-Flow starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Snow-Flow.",
