...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Snow-Flow",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Snow-Flow.",
  ...
  "provider.connect.opencodeZen.line1":
    "Snow-Flow Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Snow-Flow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Snow-Flow.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i snow-code.jsonc",
  ...
  "dialog.server.description": "Bytt hvilken Snow-Flow-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Snow-Flow ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Snow-Flow-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (snow-code.jsonc)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Snow-Flow ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Snow-Flow inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Snow-Flow",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Snow-Flow ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Snow-Flow er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Snow-Flow starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Snow-Flow.",
