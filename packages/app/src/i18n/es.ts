export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Snow-Flow",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Snow-Flow.",
  ...
  "provider.connect.opencodeZen.line1":
    "Snow-Flow Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Snow-Flow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Snow-Flow.",
  ...
  "dialog.plugins.empty": "Plugins configurados en snow-code.jsonc",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Snow-Flow se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Snow-Flow ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Snow-Flow",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (snow-code.jsonc)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Snow-Flow no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Snow-Flow incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Snow-Flow",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Snow-Flow en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Snow-Flow.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Snow-Flow",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Snow-Flow.",
