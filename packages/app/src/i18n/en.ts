export const dict = {
  ...
  "prompt.example.1": "Create a Business Rule for incident assignment",
  "prompt.example.2": "Query all active incidents assigned to me",
  "prompt.example.3": "Deploy a widget to the Service Portal",
  "prompt.example.4": "Create a Script Include for REST integration",
  "prompt.example.5": "Set up an OAuth profile for my instance",
  ...
  "dialog.plugins.empty": "Plugins configured in snow-code.jsonc",
