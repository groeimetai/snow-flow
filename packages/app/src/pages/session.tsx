...
export default function Page() {
  ...
  // Hosted TUI layout: file tree (left) + terminal (full-height right), no chat panel
  if (import.meta.env.VITE_SNOW_FLOW_HOSTED) {
    return (
      <div class="relative bg-background-base size-full overflow-hidden flex flex-col">
        ...
        <div class="flex-1 min-h-0 flex flex-row">
          ...
          <Show when={layout.fileTree.opened()}>
            ...
            >
              <div class="h-full border-r border-border-weak-base flex flex-col overflow-hidden group/filetree">
                <Tabs variant="pill" value="all" class="h-full" data-scope="filetree">
                  <Tabs.List>
          ...
          {/* Terminal (fills remaining space, full-height) */}
                    ...
                    <Tabs.List class="h-10">
                      <SortableProvider ids={terminal.all().map((t: LocalPTY) => t.id)}>
                        <For each={terminal.all()}>
                          {(pty) => (
                            <SortableTerminalTab terminal={pty} />
                          )}
                        </For>
                      </SortableProvider>
