    ...
    this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
      tools: [
        // Flow Designer Tools - Management & Execution Only (Creation via UI)
        {
          ...
          description:
            "Lists available Flow Designer flows in the instance. Shows flow status, trigger tables, and execution statistics.",
          inputSchema: {
            type: "object",
            properties: {
        ...
        },
        {
          ...
          description:
            "Executes an existing flow with provided input data. Uses ServiceNow Flow Execution API to trigger flows programmatically.",
          inputSchema: {
            type: "object",
            properties: {
        ...
        },
        {
          ...
          description:
            "Retrieves execution history for a specific flow, including success/failure statistics and execution logs.",
          inputSchema: {
            type: "object",
            properties: {
        ...
        },
        {
          ...
          description:
            "Gets detailed information about a specific flow including actions, triggers, and configuration.",
          inputSchema: {
            type: "object",
            properties: {
        ...
        },
        {
          ...
          description:
            "Imports a flow from an XML update set or flow export. This is the only supported way to programmatically create flows.",
          inputSchema: {
            type: "object",
            properties: {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              root_macroponent: {
                type: "string",
                description:
                  "Root macroponent sys_id (usually x_snc_app_shell_uib_app_shell, auto-detected if not provided)",
              },
        ...
        // UI Builder Page Management (sys_ux_page) - REQUIRES UI BUILDER PLUGIN
        {
          ...
          description:
            "Creates a new UI Builder page in the Now Experience Framework using official ServiceNow sys_ux_page API. ⚠️ REQUIRES: UI Builder plugin + ui_builder_admin role. ALTERNATIVE: Use Service Portal pages if plugin unavailable.",
          inputSchema: {
            type: "object",
            properties: {
        ...
        },
        {
          ...
          description:
            "Safely deletes a UI Builder page and all associated elements, with comprehensive dependency validation.",
          inputSchema: {
            type: "object",
            properties: {
              ...
              clean_orphaned_elements: {
                type: "boolean",
                description: "Clean up orphaned page elements",
                default: true,
              },
            },
            required: ["page_id"],
        ...
        },
        {
          ...
          description:
            "Discovers all UI Builder pages in the instance with advanced filtering and relationship analysis.",
          inputSchema: {
            type: "object",
            properties: {
              ...
              include_data_brokers: {
                type: "boolean",
                description: "Include data broker configurations",
                default: false,
              },
        ...
        // UI Builder Component Library Management (sys_ux_lib_*)
        {
          ...
          description:
            "Creates a custom UI Builder component using official ServiceNow sys_ux_lib_component and sys_ux_lib_source_script APIs.",
          inputSchema: {
            type: "object",
            properties: {
              ...
              properties_schema: {
                type: "object",
                description: "Component properties schema definition (JSON Schema)",
              },
              events: { type: "array", items: { type: "string" }, description: "Events this component can emit" },
              dependencies: {
                type: "array",
                items: { type: "string" },
                description: "External dependencies (libraries, other components)",
              },
        ...
        },
        {
          ...
          description:
            "Discovers all available UI Builder components including ServiceNow built-in and custom components with comprehensive metadata.",
          inputSchema: {
            type: "object",
            properties: {
              category: {
                type: "string",
                description: "Filter by component category (layout, input, display, custom)",
              },
              custom_only: { type: "boolean", description: "Show only custom components", default: false },
              built_in_only: {
                type: "boolean",
                description: "Show only ServiceNow built-in components",
                default: false,
              },
              include_source: { type: "boolean", description: "Include component source code", default: false },
              include_usage_stats: {
                type: "boolean",
                description: "Include component usage statistics across pages",
                default: false,
              },
        ...
        // UI Builder Data Broker Management (sys_ux_data_broker)
        {
          ...
          description:
            "Creates a UI Builder data broker for connecting pages to ServiceNow data sources using official sys_ux_data_broker API.",
          inputSchema: {
            type: "object",
            properties: {
              ...
              type: {
                type: "string",
                enum: ["table", "script", "rest_message"],
                description: "Data broker type",
                default: "table",
              },
        ...
        },
        {
          ...
          description:
            "Configures or updates an existing UI Builder data broker with new query, fields, or performance settings.",
          inputSchema: {
            type: "object",
            properties: {
        ...
        // UI Builder Page Layout Management (sys_ux_page_element)
        {
          ...
          description:
            "Adds a component element to a UI Builder page using official sys_ux_page_element API with full layout control.",
          inputSchema: {
            type: "object",
            properties: {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              validate_dependencies: {
                type: "boolean",
                description: "Check for element dependencies before removal",
                default: true,
              },
              cleanup_orphaned_data: {
                type: "boolean",
                description: "Clean up orphaned data brokers and scripts",
                default: true,
              },
            },
            required: ["element_id"],
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              include_security: {
                type: "boolean",
                description: "Include role and security information",
                default: false,
              },
              include_parameters: {
                type: "boolean",
                description: "Include URL parameter configurations",
                default: false,
              },
        ...
        // UI Builder Client Script Management (sys_ux_client_script)
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              type: {
                type: "string",
                enum: ["onLoad", "onChange", "onClick", "onSubmit", "custom"],
                description: "Script trigger type",
              },
        ...
        },
        {
          ...
          description:
            "Creates client state management configuration for UI Builder pages using official sys_ux_client_state API.",
          inputSchema: {
            type: "object",
            properties: {
              page_id: { type: "string", description: "Target page sys_id" },
        ...
        // UI Builder Event Management (sys_ux_event)
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              global_event: {
                type: "boolean",
                description: "Global event accessible across all pages",
                default: false,
              },
        ...
        // UI Builder Validation & Analytics
        {
          ...
          description:
            "Analyzes UI Builder page performance including load times, component efficiency, and optimization recommendations.",
          inputSchema: {
            type: "object",
            properties: {
        ...
        },
        {
          ...
          description:
            "Validates UI Builder page structure, component relationships, data flow integrity, and best practices compliance.",
          inputSchema: {
            type: "object",
            properties: {
              ...
              check_data_brokers: {
                type: "boolean",
                description: "Validate data broker connections and queries",
                default: true,
              },
              check_component_dependencies: {
                type: "boolean",
                description: "Check component dependencies and compatibility",
                default: true,
              },
              check_routing: {
                type: "boolean",
                description: "Validate page routing and URL configuration",
                default: true,
              },
              check_security: {
                type: "boolean",
                description: "Validate security, ACLs, and access controls",
                default: true,
              },
              check_performance: {
                type: "boolean",
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              include_conversion_rates: {
                type: "boolean",
                description: "Include conversion and engagement rates",
                default: false,
              },
      ...
      try {
        ...
        switch (name) {
          ...
          case "snow_create_ux_experience":
            result = await this.safeToolExecution(
              "snow_create_ux_experience",
              () => this.snow_create_ux_experience(args),
              "now_experience_framework",
            )
            break
          case "snow_create_ux_app_config":
            result = await this.safeToolExecution(
              "snow_create_ux_app_config",
              () => this.snow_create_ux_app_config(args),
              "now_experience_framework",
            )
            break
          case "snow_create_ux_page_macroponent":
            result = await this.safeToolExecution(
              ...
              () => this.snow_create_ux_page_macroponent(args),
              "now_experience_framework",
            )
            break
          case "snow_create_ux_page_registry":
            result = await this.safeToolExecution(
              ...
              () => this.snow_create_ux_page_registry(args),
              "now_experience_framework",
            )
            break
          case "snow_create_ux_app_route":
            result = await this.safeToolExecution(
              ...
              () => this.snow_create_ux_app_route(args),
              "now_experience_framework",
            )
            break
          case "snow_update_ux_app_config_landing_page":
            result = await this.safeToolExecution(
              ...
              () => this.snow_update_ux_app_config_landing_page(args),
              "now_experience_framework",
            )
            break
          case "snow_create_complete_workspace":
            result = await this.safeToolExecution(
              ...
              () => this.snow_create_complete_workspace(args),
              "now_experience_framework",
            )
            break
          case "snow_create_configurable_agent_workspace":
            result = await this.safeToolExecution(
              ...
              () => this.snow_create_configurable_agent_workspace(args),
              "agent_workspace",
            )
            break
          case "snow_discover_all_workspaces":
            result = await this.safeToolExecution(
              ...
              () => this.discoverAllWorkspaces(args),
              "now_experience_framework",
            )
            break
          ...
          case "snow_discover_uib_pages":
            result = await this.safeToolExecution(
              "snow_discover_uib_pages",
              () => this.discoverUIBPages(args),
              "ui_builder",
            )
            break
          ...
          case "snow_create_uib_component":
            result = await this.safeToolExecution(
              ...
              () => this.createUIBComponent(args),
              "ui_builder",
            )
            break
          case "snow_update_uib_component":
            result = await this.safeToolExecution(
              "snow_update_uib_component",
              () => this.updateUIBComponent(args),
              "ui_builder",
            )
            break
          case "snow_discover_uib_components":
            result = await this.safeToolExecution(
              "snow_discover_uib_components",
              () => this.discoverUIBComponents(args),
              "ui_builder",
            )
            break
          case "snow_clone_uib_component":
            result = await this.safeToolExecution(
              "snow_clone_uib_component",
              () => this.cloneUIBComponent(args),
              "ui_builder",
            )
            break
...
✨ Use snow_get_flow_execution_status to monitor progress.`,
  ...
  private async getFlowExecutionStatus(args: any) {
    try {
      ...
      const flowName =
        flowResponse.success && flowResponse.data.result.length ? flowResponse.data.result[0].name : execution.flow
      ...
      if (args.include_logs !== false) {
        ...
        if (logsResponse.success && logsResponse.data.result.length) {
          ...
          logInfo = `\n\n📋 **Recent Logs**:\n${logs.map((log: any) => `• ${log.level}: ${log.message}`).join("\n")}`
        }
      }
      ...
      if (args.include_actions !== false) {
        ...
        if (actionsResponse.success && actionsResponse.data.result.length) {
          ...
          actionsInfo = `\n\n⚡ **Actions** (${actions.length}):\n${actions
            .map((action: any) => `• ${action.order || "?"}: ${action.name} (${action.type})`)
            .join("\n")}`
        }
      }
      ...
      if (args.include_triggers !== false) {
        ...
        if (triggersResponse.success && triggersResponse.data.result.length) {
          ...
          triggersInfo = `\n\n🎯 **Triggers** (${triggers.length}):\n${triggers
            .map(
              (trigger: any) => `• ${trigger.type}: ${trigger.condition || "Always"} ${trigger.active ? "✅" : "❌"}`,
            )
            .join("\n")}`
        }
      }
    ...
    try {
      ...
      if (!mobileTableCheck.success) {
        return {
          success: false,
          error:
            "ServiceNow Mobile app tables not accessible. This feature requires Mobile Publishing plugin and Mobile Application Management licensing.",
          suggestion:
            'Install Mobile Publishing plugin: System Applications → ServiceNow Store → Search "Mobile Publishing". Requires separate licensing.',
      ...
      if (!response.success) {
        ...
        if (response.error?.includes("400") || response.error?.includes("Bad Request")) {
          return {
            success: false,
            error:
              "Mobile app configuration failed. ServiceNow Mobile Publishing plugin may not be installed or properly configured.",
            suggestion:
              "Verify Mobile Publishing plugin is installed and activated. Check ServiceNow Store for Mobile Publishing application.",
          }
        }
        if (response.error?.includes("403") || response.error?.includes("Forbidden")) {
          return {
            success: false,
            error:
              "Insufficient permissions for mobile app configuration. Requires mobile_admin role or admin privileges.",
    ...
    try {
      ...
      if (!layoutTableCheck.success) {
        return {
          success: false,
          error:
            "Mobile layout tables not accessible. Requires ServiceNow Mobile Publishing plugin and Mobile Device Management licensing.",
          suggestion:
            "Install Mobile Publishing plugin from ServiceNow Store. Contact ServiceNow sales for Mobile Application Management licensing.",
    ...
    try {
      ...
      if (!syncTableCheck.success) {
        return {
          ...
          suggestion:
            "Install Mobile Publishing plugin for offline sync. Alternative: Use ServiceNow Agent mobile app for basic offline access.",
    ...
    try {
      ...
      if (args.include_layouts) {
        ...
        if (layoutsResponse.success && layoutsResponse.data.result.length) {
          const layouts = layoutsResponse.data.result
            .map((l: any) => `  - ${l.name} (${l.table}): ${l.type}`)
            .join("\n")
          layoutsText = `\n\n📱 Mobile Layouts:\n${layouts}`
        }
      }
      ...
      if (args.include_offline) {
        ...
        if (offlineResponse.success && offlineResponse.data.result.length) {
          const offline = offlineResponse.data.result
            .map((o: any) => `  - ${o.table}: ${o.sync_frequency} (${o.max_records} records)`)
            .join("\n")
          offlineText = `\n\n💾 Offline Sync:\n${offline}`
        }
      }
...
✨ Found ${configs.length} mobile configuration(s)`,
    ...
    try {
      ...
      for (const component of components) {
        ...
        if (args.include_usage_stats) {
          const usageResponse = await this.client.searchRecords(
            "sys_ux_page_element",
            `component=${component.sys_id}^ORcomponent=${component.name}`,
          )
        ...
        if (args.include_dependencies && component.dependencies) {
          component.dependency_list = component.dependencies
            .split(",")
            .map((d) => d.trim())
            .filter((d) => d)
        }
  ...
  async cloneUIBComponent(args: any): Promise<any> {
    try {
      ...
      if (sourceComponent.source_script) {
        const sourceScriptResponse = await this.client.getRecord(
          "sys_ux_lib_source_script",
          sourceComponent.source_script,
        )
  ...
  async removeUIBPageElement(args: any): Promise<any> {
    try {
      ...
      if (args.validate_dependencies) {
        const dependentResponse = await this.client.searchRecords(
          "sys_ux_page_element",
          `container_id=${args.element_id}`,
          10,
        )
    ...
    try {
      ...
      for (const route of routes) {
        if (args.include_security && route.roles) {
          route.required_roles = route.roles
            .split(",")
            .map((r) => r.trim())
            .filter((r) => r)
        }
    ...
    try {
      ...
      if (analysis.total_components > 20) {
        analysis.recommendations.push(
          "Consider breaking page into smaller pages - many components may impact performance",
        )
      }
      if (analysis.data_brokers.some((db) => db.auto_refresh && db.cache_duration < 60)) {
        analysis.recommendations.push(
          "Some data brokers have short cache duration with auto-refresh - consider optimizing",
        )
      }
  ...
  async validateUIBPageStructure(args: any): Promise<any> {
    try {
      ...
      if (args.check_component_dependencies) {
        ...
        if (elementsResponse.success) {
          for (const element of elementsResponse.data.result) {
            const componentResponse = await this.client.searchRecords(
              "sys_ux_lib_component",
              `name=${element.component}^ORsys_id=${element.component}`,
              1,
            )
      ...
      if (args.check_accessibility) {
        validation.info.push(
          "Accessibility validation requires manual review - check for proper ARIA labels and keyboard navigation",
        )
      }
  ...
  async discoverUIBPageUsage(args: any): Promise<any> {
    try {
      ...
      usage.complexity_score =
        usage.components_count * 2 + usage.data_brokers_count * 3 + usage.client_scripts_count * 4
    ...
    try {
      ...
      if (!uxCheck.success) {
        return {
          ...
          suggestion:
            "UX Workspace creation requires the Now Experience Framework plugin. Contact your ServiceNow administrator.",
    ...
    try {
      ...
      if (args.workspace_type === "ux_experience") {
        ...
        if (experience.success) {
          ...
          const appConfigQuery = await this.client.searchRecords(
            "sys_ux_app_config",
            `experience_assoc=${args.workspace_sys_id}`,
          )
          ...
          const pagePropsQuery = await this.client.searchRecords(
            "sys_ux_page_property",
            `experience=${args.workspace_sys_id}`,
          )
   ...
   */
  private async checkPluginAvailabilityForTool(
    toolType: string,
  ): Promise<{ available: boolean; error?: string; suggestion?: string; alternative?: string }> {
    try {
      switch (toolType) {
        case "ui_builder":
          ...
          if (!uiBuilderCheck.success) {
            return {
              ...
              suggestion:
                "Install UI Builder plugin from ServiceNow Store. Requires ui_builder_admin + ui_builder_user roles.",
        ...
        case "mobile_publishing":
          ...
          if (!mobileCheck.success) {
            return {
              ...
              suggestion:
                "Install Mobile Publishing plugin from ServiceNow Store. Requires additional licensing and mobile_admin role.",
