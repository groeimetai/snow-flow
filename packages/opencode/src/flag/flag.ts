...
export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_ICON_DISCOVERY = OPENCODE_EXPERIMENTAL || truthyBoth("EXPERIMENTAL_ICON_DISCOVERY")
  export const OPENCODE_EXPERIMENTAL_DISABLE_COPY_ON_SELECT = truthyBoth("EXPERIMENTAL_DISABLE_COPY_ON_SELECT")
  export const OPENCODE_ENABLE_EXA = truthyBoth("ENABLE_EXA") || OPENCODE_EXPERIMENTAL || truthyBoth("EXPERIMENTAL_EXA")
