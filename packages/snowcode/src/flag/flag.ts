export namespace Flag {
  ...
  // Debug features - Master debug flag enables all debugging
  export const SNOWCODE_DEBUG = truthy("SNOWCODE_DEBUG") || truthy("OPENCODE_DEBUG")
  export const SNOWCODE_DEBUG_TOKENS = SNOWCODE_DEBUG || truthy("SNOWCODE_DEBUG_TOKENS") || truthy("OPENCODE_DEBUG_TOKENS")
  export const SNOWCODE_DEBUG_TOOLS = SNOWCODE_DEBUG || truthy("SNOWCODE_DEBUG_TOOLS") || truthy("OPENCODE_DEBUG_TOOLS")
  export const SNOWCODE_DEBUG_MCP = SNOWCODE_DEBUG || truthy("SNOWCODE_DEBUG_MCP") || truthy("OPENCODE_DEBUG_MCP")
