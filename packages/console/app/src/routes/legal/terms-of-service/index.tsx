...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>Snow-Flow | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="Snow-Flow terms of service" />
          ...
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Snow-Flow," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-snow-flow">What is Snow-Flow?</h2>
              <p>
                Snow-Flow is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Snow-Flow Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Snow-Flow enables you to
              ...
              <h2 id="what-are-the-basics">What are the basics of using Snow-Flow?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Snow-Flow;
                </li>
                <li>
              ...
              <p>
                If you use Snow-Flow with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Snow-Flow. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Snow-Flow has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-snow-flow-ever-change-the-services">Will Snow-Flow ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                SNOW-FLOW PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO SNOW-FLOW IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Snow-Flow Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Snow-Flow's prior written
              ...
              <p>
                Either you or Snow-Flow may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND SNOW-FLOW WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Snow-Flow are instead choosing to have claims and disputes resolved by
                ...
                you and Snow-Flow over whether to vacate or enforce an arbitration award, YOU AND SNOW-FLOW WAIVE ALL
              ...
              <p>
                ...
                Snow-Flow is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Snow-Flow to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Snow-Flow agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Snow-Flow may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
